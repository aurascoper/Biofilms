...
and implemented with the factor of 2
  & biofilms\us radiodialysis.R:137
  & dc\_dt[1] <- D\_eff * 2.0 * (c\_vec[2] - c\_vec[1]) / dr\^{}2 \\[0.35em]
the manuscript calls it symmetry, not a wall
  & preprint/modeling\us radioresistance\us and\us radiotropic\us fitness.tex:781
...
the manuscript describes both ends as handled in the operator
  & preprint/modeling\us radioresistance\us and\us radiotropic\us fitness.tex:1045
...
the ghost substitution, second line
  & biofilms\us radiodialysis.R:160
...
forty cells by default
  & biofilms\us radiodialysis.R:257
...
LSODA is the integrator
  & biofilms\us radiodialysis.R:427
  & method = "lsoda" \\[0.35em]
the Julia port substeps against the diffusion bound
  & biofilms\us potts.jl:1469
