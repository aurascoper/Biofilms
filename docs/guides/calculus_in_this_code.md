...
| the manuscript calls it symmetry, not a wall | `preprint/modeling_radioresistance_and_radiotropic_fitness.tex:753` | `Zero-flux symmetry is imposed at $r = 0$.` |
...
| the manuscript claims both ends are in the operator | `preprint/modeling_radioresistance_and_radiotropic_fitness.tex:1005` | `represented explicitly in the semi-discrete operator` |
