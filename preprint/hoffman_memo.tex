...
That is a web search, so it reaches ranked results and not a corpus, and conference proceedings sit
largely outside it --- which is where such a study would most likely be.

\vspace{2mm}
Every substrate those searches did return passivates through chromia, or is aluminium, or is carbon
steel. FeCrAl passivates through a mixed Cr(III)/Al(III) film.\footnote{\textit{J.\ Electrochem.\
Soc.} 172(12):121501, 2025. Model Fe--Cr10--Al$_x$ alloys in sulphate at pH~1, room temperature;
Al(III) surface enrichment 46.3\% against 1.1\% Cr for the binary. Commercial grades in borated
water show an Al--Cr-rich layer at 360\,$^\circ$C; searching on 30 August 2026 I found none measured at pool temperature.}
Whether that matters to a biofilm is the kind of question I would be asking you. The irradiated case
is not open --- irradiation makes aqueous corrosion of FeCrAl worse\footnote{\textit{Corros.\ Sci.}
174:108824, 2020, simulated PWR primary water. The $\alpha'$ that changes the surface is
characterised to 7.0~dpa at 320--382\,$^\circ$C in APMT and Alkrothal 720.} --- but that was
established at reactor conditions, and the same day's searching did not return it asked at pool
temperature, or asked anywhere with a film on the surface.
\end{minipage}
