...
transport question next to it is not asked. A facility is also the only setting where the inputs
to it are obtainable rather than assumed --- a bounded geometry, a characterised source, a
measurable metal inventory, and a dose rate in the regime the $D_{10}$ priors were measured in.
