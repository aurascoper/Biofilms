...
look like $5\times10^{-5}$ rather than $7.5\times10^{-2}$.}
...
and in the acceptance-favouring direction, only fifteen times smaller than the melanin term rather
than four orders. Radiation can therefore influence
...
$\beta_{s,\mathrm{ion}}$: the source gaining a site contributes $+\beta_{s,\mathrm{ion}} I_\gamma$
and the target losing one contributes $-\beta_{s,\mathrm{ion}} I_\gamma$. A move is favoured when
the total is negative, so a \emph{positively} signed species vacating a site favours acceptance
exactly as much as a negatively signed one occupying it. The largest such contribution is therefore
set by $\max_s |\beta_{s,\mathrm{ion}}| = 7.5\times10^{-2}$, not by the smallest magnitude, and it
is $1.5\times10^{3}$ times the $5\times10^{-5}$ the previous version of this paragraph claimed as a
bound. Measured over the run, $29.8\%$ of evaluated proposals carry
$\Delta H_{\mathrm{rad}} < -5\times10^{-5}$ and the extreme reaches $-7.5\times10^{-2}$.
...
positively signed species vacating a site favours acceptance by up to $7.5\times10^{-2}$.
