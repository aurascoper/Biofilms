...
\textbf{This model resolves none of that.} \texttt{compute\_delta\_H\_terms} and
\texttt{mcs\_step!} read the lattice, volumes, species, adhesion couplings,
$\beta_{s,\mathrm{ion}}$ and melanin, and never the nutrient field; organic carbon is an exogenous
input the CPM does not represent. Nothing in this paragraph is a claim about the metabolism of the
