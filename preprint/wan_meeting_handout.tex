...
\begin{itemize}
  ...
  \item \textbf{Inactivated.} Biosorption is metabolically independent, so dead or
        heat/azide-killed biomass is standard in this literature. That removes viability
        maintenance from the first experiment.
...
\begin{itemize}
  ...
  \item \textbf{Metabolic control} --- azide or a temperature shift, to demonstrate uptake
        is passive and not respiration-linked.
...
{\large\bfseries\color{solver} The bridge}\\[3pt]
